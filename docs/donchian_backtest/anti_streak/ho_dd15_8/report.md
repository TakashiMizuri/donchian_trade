...
| Metric | Value |
|---|---|
| Final balance | $19,240.27 |
| Net PnL | $9,240.27 |
| Return | 92.40% |
| Max drawdown | -15.21% |
| Trades | 516 |
| Closed | 289 (SL 172 / channel 117) |
| Open | 0 |
| Net-positive after fees | 27.34% |
| Profit factor | 1.26 |
| Sum of realized R | 114.0 |
| Avg realized R | +0.394 |
| Max concurrent | 1 |
| Commission total | $5,792.95 |
